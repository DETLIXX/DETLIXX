...
<p>When I was 15, I was interested in coding, so I start with c# because it was something that I found "first", then I made a few apps, only fun made, then I try to code some Discord Bot using c# it was fun, but yeah I quit it. In 2018 I buy my new gaming pc, so I start learning Unity, and I made a few games that I never post on git so I lost it when I sold my pc 😖 so now I am learning Web Dev but using Git 😂 </p>
